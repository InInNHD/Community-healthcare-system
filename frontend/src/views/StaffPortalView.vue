...
@media(max-width:1280px){.portal-navigation{grid-template-columns:repeat(3,1fr)}.summary-grid{grid-template-columns:repeat(2,1fr)}.patient-card-grid{grid-template-columns:repeat(2,1fr)}.medicine-grid{grid-template-columns:repeat(2,1fr)}.resident-row{grid-template-columns:48px minmax(130px,1fr) minmax(190px,1.2fr) auto}.resident-tags{display:none}}
</style>
