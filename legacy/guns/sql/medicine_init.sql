...
-- 1. 新增字段
ALTER TABLE `medicine_info` ADD COLUMN `medicine_image` varchar(255) DEFAULT NULL COMMENT '药品图片路径' AFTER `medicine_value`;
ALTER TABLE `medicine_info` ADD COLUMN `medicine_category` varchar(50) DEFAULT NULL COMMENT '药品分类' AFTER `medicine_image`;
...
('开瑞坦（氯雷他定）', 25, '缓解过敏性鼻炎、慢性荨麻疹等相关症状', '/static/img/medicine/respiratory.svg', '呼吸用药'),
